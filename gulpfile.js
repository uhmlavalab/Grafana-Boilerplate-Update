...
var createJS = function(options){
    ...
    var file_name = (options.dev) ? 'boilerplate_'+name_lower+'.js' : 'boilerplate_'+name_lower+'.min.js';
...
var createCSS = function(options){
    ...
    var file_name = (options.dev) ? 'boilerplate_'+name_lower+'.css' : 'boilerplate_'+name_lower+'.min.css';
    ...
    return gulp.src("./js/**/*.js")
        .pipe(yuidoc.parser({
            project: {
                ...
                "description": "NetSage Boilerplate API ",
                "version": "1.0.3",
